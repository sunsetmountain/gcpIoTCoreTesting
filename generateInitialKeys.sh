...
openssl ec -in ec_private.pem -pubout -out ec_public_on_deck.pem
openssl ecparam -genkey -name prime256v1 -noout -out ec_private_at_bat.pem
openssl ec -in ec_private.pem -pubout -out ec_public_at_bat.pem
openssl ecparam -genkey -name prime256v1 -noout -out ec_private_on_base.pem
openssl ec -in ec_private.pem -pubout -out ec_public_on_base.pem
