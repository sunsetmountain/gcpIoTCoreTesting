...
def mqtt_device_demo(args):
    ...
    client = get_client(
      ...
      testCertPayload = "-----BEGIN PUBLIC KEY-----
MFkwEwYHKoZIzj0CAQYIKoZIzj0DAQcDQgAEzIype8mYfgJplPoM1tVwEFgQMahD
bgS/FFKQCz0osub44ghzldQrGbOgRchnrZCFtrvRISUGs6ghRd60rCBR4g==
-----END PUBLIC KEY-----"
